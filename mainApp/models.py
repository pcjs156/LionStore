...
#     seller = models.ForeignKey(WebSeller, on_delete=models.SET_NULL, null=True, related_name='webSellInfoSeller', verbose_name="웹 판매자")
...
#     seller = models.ForeignKey(Stationer, on_delete=models.SET_NULL, null=True, related_name='StationerSellInfoSeller', verbose_name="문방구 판매자")
#     price = models.PositiveIntegerField(verbose_name="판매가")
#     reported = models.BooleanField(default=False, verbose_name="신고")
